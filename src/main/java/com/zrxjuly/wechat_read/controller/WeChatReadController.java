...
public class WeChatReadController {
	...
	public ModelAndView userInfoEdit(HttpServletRequest request, HttpServletResponse response)
	 ...
	 * @return
	 */
	@RequestMapping("/shareBookWeekly")
	public ModelAndView shareBooks() {
		ModelAndView mav = new ModelAndView();

		// 从数据库中检索出一条图书的信息.
		ShareBook shareBook = weChatUserInfoService.selectBook();
		
		mav.addObject("shareBook", shareBook);
		mav.setViewName("sharebook_weekly");
		return mav;
	}
